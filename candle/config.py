...
config = {
    ...
    "controllers": {
        "con1": {
            "type": "opx1",
            "analog_outputs": {
                1: pars['qb_offsets'][0],  # qubit I
                2: pars['qb_offsets'][1],  # qubit Q
                3: pars['rr_offsets'][0],  # rr I
                4: pars['rr_offsets'][1],  # rr Q  
            },
            "digital_outputs": {},
            "analog_inputs": {
    ...
    "waveforms": {
        ...
        "pi_half_wf_i1": {"type": "arbitrary", "samples": [float(arg) for arg in pi_amp * gaussian(pars['pi_half_len'], pars['pi_half_len']/5)]},
    ...
    rr_pulse_len_in_clk = pars['rr_pulse_len_in_clock']
    ...
    "mixers": {
        "mixer_q1": [{"intermediate_frequency": qb_IF, "lo_frequency": pars['qb_LO'], "correction": IQ_imbalance(*pars['qb_imbalance'])}],
        "mixer_rl1": [{"intermediate_frequency": rr_IF, "lo_frequency": pars['rr_LO'], "correction": IQ_imbalance(*pars['rr_imbalance'])}],
    }
}
